...
/**
 * JS/Web implementation of PredictiveBackHandler using browser history and keyboard events
 */
...
public actual fun PredictiveBackHandler(
    ...
    val screenWidth = remember { window.innerWidth.toFloat() }

    // Handle browser back/forward button and popstate events
    DisposableEffect(enabled) {
        if (!enabled) return@DisposableEffect onDispose { }

        val popstateListener = { _: Event ->
